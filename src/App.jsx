...
// ══════════════════════════════════════════════════════════════
function ProductEditPage({ product, onBack, sbI, sbU, sbD, setProducts }) {
...
function WhProducts({ products, setProducts, cars, setCars, sbI, sbU, sbD }) {
  ...
  if (editingFull) {
    return <ProductEditPage product={editingFull} onBack={() => { setEditingFull(null); setTimeout(() => { const mainEl=document.querySelector('.alfhd-main-area'); if(mainEl) mainEl.scrollTop=scrollPosRef.current; else window.scrollTo(0, scrollPosRef.current); }, 0); }} sbI={sbI} sbU={sbU} sbD={sbD} setProducts={setProducts} />;
  }
  return (
    <div>
