    ...
    {selectedConv ? ( <>
      ...
      <style>{`
        @media (max-width: 860px) {
          ...
          /* منطقة تمرير الرسائل: تاخذ المساحة المتبقية وتنكمش، تاركةً الشريط ثابت أسفل */
          .alfhd-conv-detail-active-mobile .alfhd-chat-scroll {
            flex: 1 1 auto !important;
            min-height: 0 !important;
            overflow-y: auto !important;
          }
          /* شريط الكتابة: ثابت أسفل دائماً، ما ينزل تحت الشاشة */
...
export default function AlFhdApp() {
  ...
  return (
    ...
    <>
      <GlobalStyles />
      {/* ── جرس الإشعارات (أعلى يمين — بالواجهة الرئيسية) ── */}
      <div style={{ position: 'fixed', top: 60, right: 14, zIndex: 90 }} className="alfhd-no-print alfhd-notif-bell">
        <button
          onClick={() => {
        ...
        {showNotifications && (
          <div style={{
            position: 'absolute', top: 52, right: 0, width: 320, maxHeight: 420, overflowY: 'auto',
