       ...
       return (
        <button
         onClick={async () => {
           ...
           const msg = allOn
             ? 'إيقاف الرد الآلي بكل المحادثات؟\n(يشمل كل المحادثات بالنظام)'
             : `تشغيل الرد الآلي بكل المحادثات؟\n(يشمل كل المحادثات بالنظام)\nمفعّل حالياً بـ${activeN} من الظاهرة.`;
         ...
         title={`مفعّل بـ${activeN} محادثة — اضغط ${allOn ? 'لإيقاف' : 'لتشغيل'} الكل`}
